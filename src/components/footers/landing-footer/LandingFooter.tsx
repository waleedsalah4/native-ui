...
function LandingFooter() {
  return (
    <footer className="bg-black px-10 pt-12 text-white lg:pt-24">
      {/* <div className="container"> */}
      <div className="grid">
        <p className="col-span-full mb-10 text-center font-Inter text-xl font-semibold md:text-[32px] md:leading-[38px]">
          Get in touch and started to up your business
          <br />
          with our Company
        </p>
      </div>
      <hr className="mt-6 block h-[1px] border-0 border-t border-white/10 pb-6 text-white/10" />
      <LandingFooterLinks />
      {/* </div> */}
    </footer>
  );
