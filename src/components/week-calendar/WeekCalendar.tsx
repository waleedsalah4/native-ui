...
const WeekCalendar = ({
  ...
  // format(addDays(startOfCurrentWeek, i), "EEEE, MMM d")
        ...
        {daysOfWeek.map((day, index) => (
          ...
          >
            ...
            <button
              ...
              className={cn(
                "flex h-6 w-6 items-center justify-center rounded-full text-sm text-[#1A1A1A] hover:bg-[#D3D8D4] md:h-10 md:w-10",
                {
                ...
                {
                  "cursor-not-allowed text-[#DBDBDB]": isBefore(day, today),
                }
              )}
            >
              {format(day, "d")}
